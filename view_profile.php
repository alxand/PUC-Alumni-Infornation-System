...
if(!isset($_GET['id']))
{
$details=getpersondetails($conn);
$comments=getcomments($conn,$_SESSION['person_id']);
}else
{
$details=getperdetails($conn,$_GET['id']);
					...
					<div class="col-md-7">
						...
						<div class="form-body">
                         ...
                         <div class="form-group">
                            ...
                            <label class="bmd-label-floating" for="uname">UserName</label>
